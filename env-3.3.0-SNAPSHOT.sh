...
export HADOOP_LOG_DIR=/opt/yarn-logs
export HADOOP_PID_DIR=${HADOOP_BASE_DIR}
export HADOOP_CONF_DIR=${HOME}/apache-hadoop-install-dir/hadoop-dev-workspace/conf_3.3.0-SNAPSHOT
export HADOOP_COMMON_HOME=${HOME}/apache-hadoop-install-dir/home_3.3.0-SNAPSHOT
